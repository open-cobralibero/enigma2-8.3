...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "Cobra-Clbs-FHD/skin.xml" or "cobraliberosat-FHD.mod/skin.xml"  # SD hardware is no longer supported by the default skin.
