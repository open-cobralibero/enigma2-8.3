...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "cobra.pli-fhd/skin.xml" or "cobraliberosat-FHD.mod.xml"  # SD hardware is no longer supported by the default skin.
