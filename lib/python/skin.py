...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "cobraliberosat-FHD.mod/skin.xml" or "cobraliberosat-clbs-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
